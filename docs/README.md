...
| **Supabase 登入、雲端 `user_app_data`、同步坑點與除錯 log（2026-03）**；**忘記密碼（§八）** | [SUPABASE_AUTH_AND_SYNC_2026-03.md](./SUPABASE_AUTH_AND_SYNC_2026-03.md) |
...
| `docs/PRODUCT_ITERATION_2025-03.md` | 2025-03 分帳／免稅迭代之書面 log；**§十 SAVE**、**§三 L20–L22**（2026-03 支出卡片／編輯坑）；**§十一** 多幣別計劃／交付／坑；**§十二** **現版匯率／稅項／分帳邏輯速查**；**§2.6–2.7** 小 UX 與匯率延伸 |
