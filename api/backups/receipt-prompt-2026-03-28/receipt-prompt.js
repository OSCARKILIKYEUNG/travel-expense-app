/**
 * 備份快照 · 2026-03-28 — 勿改此檔作為執行來源。
 * 還原方式：將本檔完整覆蓋專案根下 api/receipt-prompt.js（或只複製 export 兩段）。
 * 當時線上邏輯：parse-receipt.js → gemini-2.5-flash，systemInstruction = SYSTEM_PROMPT。
 */
